...
//			circle_inc=(int)fabs(x_inc);
			...
			else if(circle_inc>25&&circle_inc<=320)
			{
				buzzer=1;
...
//			return;
		...
		else if(motor_inc-straight_inc>=700&&motor_inc-straight_inc<2800)
		{
...
//			circle_inc=(int)fabs(x_inc);
			...
			else if(circle_inc>23&&circle_inc<=320)
			{
//				error=0.9;
				//error=(1.25*(sqrt(adc[0])-sqrt(adc[6]))+1.25*(sqrt(adc[1])-sqrt(adc[5])))/(adc[1]+adc[5]+adc[6]+adc[0]+1.35*adc[3]);
			}
...
//				return;
			...
			else if(motor_inc-straight_inc>=1400&&motor_inc-straight_inc<2800)
			{
