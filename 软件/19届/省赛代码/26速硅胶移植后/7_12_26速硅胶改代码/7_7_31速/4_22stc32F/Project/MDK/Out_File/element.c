...
//			else if(circle_inc>300&&circle_inc<=350)
//			{
//				error=-0.35;
//				buzzer = 0;
//			}
...
//			return;
		...
		else if(motor_inc-straight_inc>=800&&motor_inc-straight_inc<2200)
		{
...
//		1.0,0.11,0.087,0.97,0.115,0.235,0.5};
	...
	//		0.478,0.20,0.035,1.023,0.134,0.178,0.634, 				//第十一版室内最外边横电感180
